...
<form name="form1" id="formID" method="post" action="pigmy_ins_rate_insert.php">
  ...
  <table width="404" height="315" border="0" align="center">
    ...
    <tr>
      <td>Interest Rate </td>
      <td><input name="interest_rate" type="text" class="validate[required,custom[onlyNumber]]" id="interest_rate"></td>
    </tr>
    <tr>
      <td>Duration</td>
      <td><select name="duration" id="duration" class="validate[required]">
