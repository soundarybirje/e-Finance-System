...
<thead>
  ...
  <?php
	...
	$sql="select * from pigmy_collect a,customer_details b,pigmy_agent pa where a.customer_id=b.customer_id and a.pigmy_agent_id=pa.pigmy_agent_id and a.pigmy_agent_id='$pigmy_agent_id'";
