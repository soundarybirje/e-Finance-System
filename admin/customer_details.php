...
<?php
 include('dbconnect.php');
	$sn=1;
	$sql="select max(customer_id) from customer_details";
...
<form name="form1" id="formID" method="post" action="customer_details_insert.php">
  <p>&nbsp;</p>
    ...
    <tr>
      <td>Customer code      </td>
      <td><input name="customer_code" type="text"  class="validate[required]" readonly="" value="<?php echo $c; ?>" id="customer_code"></td>
    </tr>
    <tr>
