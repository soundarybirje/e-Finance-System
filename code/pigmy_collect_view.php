...
<thead>
  ...
  <?php
	...
	$sn=1;
	$sql="select * from pigmy_collect a,customer_details b where a.customer_id=b.customer_id";
	$res=mysql_query($sql);
  ...
  <tr>
    ...
    <td><a href="pigmy_collect_edit1.php?pigmy_collect_id=<?php echo $row['pigmy_collect_id'];?>" onClick="return confirm('are you sure  want to edit this?')">Edit</a></td>
